<h2><a href="https://www.geeksforgeeks.org/problems/single-valued-subtree/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=practice_card">Single valued subtree</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a binary tree, count the number of Single Valued Subtrees. A Single Valued Subtree is one in which all the nodes have same value.&nbsp;</span></p>
